...
(define-object power-button (base-object) 
  :input-slots 
  (
   (power-button-file-path "power-button/" :settable)     ; main path
  ...
  :computed-slots
  (
   (data-file-path  (merge-three-paths *path-name* (the power-button-file-path) (the concept-path))) ; generate the data path
